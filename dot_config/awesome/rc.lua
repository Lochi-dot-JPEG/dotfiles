...
--beautiful.init(string.format("~/.config/awesome/powerarrow-dark/theme.lua", os.getenv("HOME"), chosen_theme))
--beautiful.init("~/.config/awesome/powerarrow-dark/theme.lua")
